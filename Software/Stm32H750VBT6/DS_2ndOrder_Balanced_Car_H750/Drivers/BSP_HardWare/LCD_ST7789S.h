...
#define TFTSPI_SCK    LCD_SCK_GPIO_Port,LCD_SCK_Pin     // SPI SCK管脚
#define TFTSPI_SDI    LCD_MOSI_GPIO_Port,LCD_MOSI_Pin     // SPI MOSI管脚
...
#define TFTSPI_CS_L     HAL_GPIO_WritePin(TFTSPI_CS,GPIO_PIN_RESET);     /* CS管脚 */
...
#define USE_HORIZONTAL 3//设置横屏或者竖屏显示
												//0:竖屏（正向）
												//1:竖屏（倒转）
												//2:横屏（正向）
												//3:横屏（倒转）
